...
class SearchService
{
    ...
    private array $synonymMap = [
        'btc'          => ['bitcoin', 'cryptocurrency', 'crypto', 'xmr', 'monero'],
        'bitcoin'      => ['btc', 'cryptocurrency', 'crypto', 'payment'],
        'xmr'          => ['monero', 'privacy coin', 'crypto', 'stealth'],
        'monero'       => ['xmr', 'privacy coin', 'crypto'],
        'crypto'       => ['bitcoin', 'btc', 'cryptocurrency', 'blockchain', 'xmr', 'monero', 'wallet'],
        'market'       => ['marketplace', 'shop', 'store', 'vendor', 'dnm', 'darknet market'],
        'marketplace'  => ['market', 'shop', 'store', 'vendor', 'dnm'],
        'dnm'          => ['market', 'marketplace', 'darknet market'],
        'shop'         => ['market', 'store', 'vendor', 'ecommerce'],
        'email'        => ['mail', 'messaging', 'inbox', 'protonmail', 'tutanota', 'cockli'],
        'mail'         => ['email', 'messaging', 'inbox'],
        'forum'        => ['community', 'board', 'discussion', 'forums', 'dread'],
        'forums'       => ['community', 'board', 'discussion', 'forum'],
        'chat'         => ['messaging', 'im', 'communication', 'irc', 'jabber', 'xmpp'],
        'vpn'          => ['privacy', 'anonymity', 'tunnel', 'proxy'],
        'privacy'      => ['anonymous', 'vpn', 'security', 'encryption', 'stealth', 'anonymity'],
        'anonymity'    => ['privacy', 'anonymous', 'stealth', 'incognito'],
        'security'     => ['privacy', 'encryption', 'protection', 'cybersecurity', 'pentest'],
        'hosting'      => ['server', 'host', 'vps', 'web hosting', 'offshore', 'bulletproof'],
        'offshore'     => ['hosting', 'privacy', 'seychelles', 'panama'],
        'blog'         => ['news', 'article', 'post', 'journal'],
        'news'         => ['blog', 'article', 'media', 'press', 'onion news'],
        'wallet'       => ['bitcoin wallet', 'crypto wallet', 'payment', 'ledger', 'electrum', 'wasabi'],
        'search'       => ['find', 'lookup', 'engine', 'index', 'directory', 'crawler'],
        'leak'         => ['whistleblowing', 'expose', 'disclosure', 'wiki'],
        'wiki'         => ['encyclopedia', 'knowledge', 'directory', 'hidden wiki'],
        'drugs'        => ['pharmacy', 'substance', 'cannabis', 'weed'],
        'hack'         => ['exploit', 'vulnerability', 'pentest', 'security', 'cracking'],
        'tor'          => ['onion', 'hidden service', 'darknet', 'deepweb'],
        'onion'        => ['tor', 'hidden service', 'darknet', 'deepweb'],
        'free'         => ['gratis', 'no cost', 'open source', 'foss'],
        'file'         => ['upload', 'download', 'storage', 'sharing', 'hosting'],
        'book'         => ['library', 'ebook', 'archive', 'pdf', 'literature'],
        'library'      => ['book', 'archive', 'collection', 'repository'],
        'social'       => ['network', 'community', 'media', 'facebook', 'twitter clone'],
        'service'      => ['tool', 'utility', 'platform'],
    ];
    ...
    public function scoreResults(Collection $links, array $tokens, array $synonyms, array $intent, string $query, array $parsed = []): Collection
    {
        ...
        $links->each(function ($link) use ($tokens, $synonyms, $intent, $query, $docCount, $dfMap, $analytics) {
            ...
            // ── 3. Phrase Proximity & Exact Match Bonus ────────────
