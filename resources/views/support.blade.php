<x-app.layouts title="Support Center">
    ...
    <div style="max-width:760px;margin:0 auto;padding:1.5rem 0 3rem;">
        ...
        <div style="text-align:center;margin-bottom:2rem;">
            <h1 style="font-size:1.75rem;font-weight:900;color:#fff;margin:0 0 .4rem;letter-spacing:-.02em;">Support Center</h1>
            <p style="color:var(--color-gh-dim);font-size:.9rem;margin:0;">Get help, report issues, or support the project</p>
        </div>

        {{-- FAQ --}}
        <section style="margin-bottom:2rem;">
            <h2 style="font-size:.8rem;font-weight:800;text-transform:uppercase;letter-spacing:.12em;color:var(--color-gh-dim);margin:0 0 .75rem;">
