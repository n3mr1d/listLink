    ...
    <div class="max-w-4xl mx-auto py-12 px-6">
        ...
        <section class="mb-16">
            <h2 class="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                <i class="fas fa-question-circle text-gh-accent"></i> Frequently Asked Questions
            </h2>
            ...
            <div class="space-y-4">
                ...
                <details class="group bg-gh-bar-bg border border-gh-border rounded-xl overflow-hidden shadow-sm">
                    <summary class="flex items-center justify-between p-5 cursor-pointer hover:bg-gh-border/50 transition-colors list-none">
                        ...
                        <i class="fas fa-chevron-down text-gh-dim group-open:rotate-180 transition-transform"></i>
                    </summary>
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center gap-6">
                    <div class="flex items-center gap-4 min-w-[200px]">
                        <div class="w-12 h-12 flex items-center justify-center rounded-xl bg-orange-500/10 text-orange-500 border border-orange-500/20 text-xl">
                ...
                <div class="flex flex-col md:flex-row md:items-center gap-6">
                    <div class="flex items-center gap-4 min-w-[200px]">
                        <div class="w-12 h-12 flex items-center justify-center rounded-xl bg-blue-500/10 text-blue-500 border border-blue-500/20 text-xl">
