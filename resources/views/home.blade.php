<x-app.layouts title="Verified Tor .Onion Directory"
        ...
        <div class="hero-content">
            ...
            <div class="hero-stats">
                <div class="stat-item">
                    ...
                    <span class="stat-label">Verified Links</span>
                </div>
                <div class="stat-divider"></div>
                <div class="stat-item">
                    <span class="stat-value">{{ number_format($stats['online_links']) }}</span>
                    <span class="stat-label">Online Now</span>
                </div>
                <div class="stat-divider"></div>
                <div class="stat-item">
                    <span class="stat-value">{{ number_format($stats['indexed_count']) }}</span>
    ...
    <style>
        ...
        .status-dot.uptime-online { background-color: #238636; box-shadow: 0 0 10px rgba(35, 134, 54, 0.5); }
        .status-dot.uptime-offline { background-color: #da3633; }
        .status-dot.uptime-unknown { background-color: #8b949e; }
