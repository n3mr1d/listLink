<x-app.layouts title="Create Account">
    ...
    <div style="max-width:440px;margin:0 auto;padding:2rem 0;">
        ...
        {{-- Global Errors --}}
        @if($errors->any())
            <div style="border:1px solid rgba(248,113,113,.25);border-radius:.45rem;padding:.75rem 1rem;margin-bottom:1rem;background:rgba(248,113,113,.06);">
            ...
            <div style="padding:1.5rem;">
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div style="margin-bottom:1rem;">
                        ...
                        <div style="display:flex;align-items:center;background:var(--color-gh-bg);border:1px solid {{ $errors->has('username') ? 'rgba(248,113,113,.5)' : 'var(--color-gh-border)' }};border-radius:.45rem;overflow:hidden;">
                        ...
                        <p style="font-size:.55rem;color:var(--color-gh-dim);opacity:.5;margin:.25rem 0 0;">3–20 characters. Letters, numbers, underscores only.</p>
                    </div>
                    ...
                    <div style="margin-bottom:1rem;">
                        ...
                        <div style="display:flex;align-items:center;background:var(--color-gh-bg);border:1px solid {{ $errors->has('password') ? 'rgba(248,113,113,.5)' : 'var(--color-gh-border)' }};border-radius:.45rem;overflow:hidden;">
                            <div style="padding:0 .65rem;display:flex;align-items:center;color:var(--color-gh-dim);opacity:.4;">
                        ...
                        <p style="font-size:.55rem;color:var(--color-gh-dim);opacity:.5;margin:.25rem 0 0;">Minimum 6 characters.</p>
                    </div>

                    {{-- Password Confirm --}}
                    <div style="margin-bottom:1.25rem;">
                        <label for="password_confirmation" style="font-size:.6rem;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:var(--color-gh-dim);display:block;margin-bottom:.35rem;">Confirm Password *</label>
                    ...
                    {{-- Submit --}}
                    <button type="submit" id="register-submit" style="width:100%;padding:.65rem;background:var(--color-gh-accent);color:#0d1117;border:none;border-radius:.45rem;font-size:.75rem;font-weight:900;text-transform:uppercase;letter-spacing:.06em;cursor:pointer;">
                        Register Identity
                    </button>
                </form>
