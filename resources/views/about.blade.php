<x-app.layouts title="About Hidden Line" description="Learn more about Hidden Line, the ultimate Tor-optimized .onion directory providing verified links, uptime monitoring, and decentralized access.">
    ...
    <div style="max-width:760px;margin:0 auto;padding:1.5rem 0 3rem;">
        ...
        <div style="text-align:center;margin-bottom:2rem;">
            <h1 style="font-size:1.75rem;font-weight:900;color:#fff;margin:0 0 .5rem;letter-spacing:-.02em;">About Hidden Line</h1>
        ...
        <section style="border:1px solid var(--color-gh-border);border-radius:.6rem;padding:1.25rem;margin-bottom:1rem;">
            ...
            <p style="color:var(--color-gh-text);line-height:1.7;font-size:.88rem;margin:0;">
                Hidden Line is built with a single philosophy: <strong style="color:#fff;">freedom of information without compromise</strong>.
        ...
        <section style="margin-bottom:1.5rem;">
            ...
            <div class="about-features">
                @foreach([
                    ...
                    [ 'color' => 'rgba(74,222,128,.1)', 'title' => 'Deep Web Crawler', 'desc' => 'Hidden Line uses a custom-built, Tor-proxied crawler to actively discover and index new .onion links.'],
